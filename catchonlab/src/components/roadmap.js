        ...
        <div className={styles.timeline}>
          ...
          <div className={styles.timelineItem}>
            ...
            <div className={styles.timelineContent}>
              <h2>soul pass</h2>
              <p>
                soul pass will be airdrop to holders according to their
                soulcheck result
              </p>
            </div>
          </div>
          ...
          <div className={styles.timelineItem}>
            ...
            >
              <h2>pass utility</h2>
              <p>
                a portion of the holders will be airdrop a fail pass, fail
                simlie will be absorb by a evil forcev...
              </p>
            </div>
          </div>
