module.exports = {
  en: {
    translation: {
      ...
      roadmap: {
        p1_1: "Phase 1",
        p1_2: "Design of 4000 NFTs surrounding the classic characters of the Romance of the Three Kingdoms. ",
        p1_3: "The NFT will be based on 80 classic Three Kingdoms characters, representative of the four forces of Wei, Shu Wu, and independent heroes. Artists will design based on the background stories of the Three Kingdoms and other characteristics of the characters, several unique Three Kingdoms character cards are randomly generated throughout the program.",
        ...
        p1_7: "Establish an open community account, and transfer some of the proceeds and royalties from the first phase to the subsequent development of the project.",
        p2_1: "Phase2",
        p2_2: "According to the territory of the Three Kingdoms period, the Three Kingdoms Land NFT will be issued. ",
        ...
        p2_4: "Based on the land-staking system, land-staking participation and collaborating with other communities' whitelist spots, Three Kingdoms character card NFT, blue chip/hyped NFTs, etc.",
        ...
        p3_1: "Phase 3",
        p3_2: "Release profile-pic like NFTs of the characters of the Three Kingdoms. Each work in this series is an original art, not a program synthesis. ",
        ...
        p3_5: "War System and Community Self-Government System.",
  ...
  zh: {
    translation: {
      ...
      roadmap: {
        p1_1: "初出茅庐",
        p1_2: "围绕三国经典人物发行4000个NFT。",
        p1_3: "NFT将以魏蜀吴群四个势力中具有代表性的80个经典三国人物为原型， 艺术家会根据三国的背景故事进行设计，每名三国人物都会根据性别、文武、服饰、头饰、背景等特性，通过程序随机的生成出若干个独一无二的三国人物收藏卡。",
        ...
        p1_7: "建立公开社区账户，转入第一阶段部分收益及版税收益用于项目后续发展。",
        p2_1: "群雄割据",
        ...
        p3_1: "一齐天下",
        p3_2: "通过第一阶段和第二阶段的运营，我们会在第三阶段推出一个交互艺术pfp NFT。该作品会基于第一第二阶段进行快照，通过玩家和nft作品的协作，通过技术手段生成独一无二的PFP作品。例如，玩家持有关羽，在第三阶段mint期间，有概率在pfp上面出现青龙偃月刀的武器。",
        p3_3: "对PFP头像类的三国人物NFT作品进行发售。",
        p3_4: "对第一第二阶段的NFT通过社区合作及功能开发实现持续赋能，完善三国NFT元宇宙的生态，例如，sandbox，webb等元宇宙概念生态。",
        p3_5: "通过元宇宙生态完善战争系统与社区自治系统。",
